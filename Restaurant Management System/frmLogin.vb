...
Public Class frmLogin
            ...
            If rdr.Read() Then
                If Encrypt(Password.Text).Trim = rdr.GetValue(1).trim Then
                    ...
                    If UserType.Text = "Cashier" Then
                        ...
                        frmMainMenu.AdministrationToolStripMenuItem.Enabled = False
    ...
    Private Sub btnChangePassword_Click(sender As System.Object, e As System.EventArgs)
        Me.Hide()
    ...
    Private Sub btnKeyboard_Click(sender As System.Object, e As System.EventArgs)
        Dim old As Long
